...
<body id="page-top" class="index">
                ...
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    ...
                    if($num>0){
                        ...
                        while ($i < $num) {
                            ...
                            $createdate=mysql_result($result,$i,"create_date");
                            $createdby=mysql_result($result,$i,"created_by");
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; Grand Codes <span id="current-year"></span></span>
                </div>
                <div class="col-md-4">
